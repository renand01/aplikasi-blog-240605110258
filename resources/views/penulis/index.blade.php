    ...
    text-transform: uppercase; letter-spacing: 0.05em;">
                ...
                <tbody>
                    @forelse($penulis as $item)
                        ...
                        }}" alt="Foto {{ $item->nama_depan }}" style="width: 40px; height: 40px;
                        ...
                        color: #1565c0; font-size: 12px;">
                                ...
                                'penulis.destroy',
                                $item->id
                            ) }}" method="POST" onsubmit="return confirm('Hapus penulis
                        ini?')">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    @empty
                                        <tr>
                                            <td colspan="4" class="px-3 py-4 text-center" style="font-size: 13px; color: #999999;
                        font-style: italic;">
